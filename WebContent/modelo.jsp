...
<% ArrayList<Aparelho> listaModelo = (ArrayList<Aparelho>) request.getAttribute("modelosAparelhos");%> 
            ...
            <div class="marcas">
                <div class="list-group">
                    ...
                    <div style="background-color: #3f0955c2; color: #fff;" class="list-group-item" aria-current="true">
                        <center style="text-transform: uppercase; font-family: 'Poppins'; font-weight: bold;">Selecione o Modelo</center>
                    </div>
                    
                    <form action="armazenamento" method="POST" style="height: 60vh; overflow: auto;">
                    
	                    <%for(int i=0 ; i<listaModelo.size() ; i++){%>
		                    <button class="list-group-item list-group-item-action text-center" type="submit" name="aparelho" value="<% out.print(request.getParameter("marca")); %>;<%=listaModelo.get(i).getModeloAparelho()%>">
		                    	<%=listaModelo.get(i).getModeloAparelho()%>	                   	
		                    </button>
	                   <% } %>
