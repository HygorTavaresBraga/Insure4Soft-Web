...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23-Out-2022 às 05:57
...
(1, 'Maria Souza', '222.222.222-22', '(21) 91214-3333', 'maria@gmail.com', '12345678'),
(9, 'Luiza', '123.333.222-11', '(21) 91214-1152', 'luiza@gmail.com', '12345678');
...
INSERT INTO `enderecocliente` (`idEnderecoCliente`, `idCliente`, `cep`, `cidade`, `bairro`, `rua`, `numero`, `complemento`) VALUES
(1, 1, '26178540', 'Belford Roxo', 'SÃ£o Vicente', 'Rua Tenente Raimundo Feitosa da Silva', 32, 'Bloco 84');
...
INSERT INTO `enderecofuncionario` (`idEnderecoFuncionario`, `idFuncionario`, `cep`, `cidade`, `bairro`, `rua`, `numero`, `complemento`) VALUES
(1, 1, '26178540', 'Belford Roxo', 'Parque São Vicente', 'Tenente Raimundo', 32, 'Bloco 84'),
(2, 1, '26178540', 'Belford Roxo', 'Parque São Vicente', 'Tenente Raimundo', 32, 'Bloco 84');
...
INSERT INTO `formapagamento` (`idFormaPagamento`, `idCliente`, `formaPagamento`, `numeroCartao`, `dataValidade`, `cvv`, `titularCartao`) VALUES
(15, 9, 'Credito', '3333 3333 3333 3333', '12/12', 0, 'LUIZA'),
(16, 1, 'Debito', '6666 6666 6666 6666', '66/66', 0, 'Hygor');
...
(1, 'Admin', '(00) 00000-0000', 'i4s@adm', '000.000.000-00', '12345678', 'Administrador');
...
(40, 9, 152, 15, 'Soft Bronze', 271.5, 'Ativo'),
(41, 1, 1, 0, 'Soft Bronze', 67.47, 'Ativo'),
(42, 1, 8, 0, 'Soft Prata', 55.5, 'Em Análise'),
(43, 1, 8, 0, 'Soft Prata', 55.5, 'Em Análise'),
(44, 1, 8, 0, 'Soft Prata', 55.5, 'Em Análise'),
(45, 1, 8, 0, 'Soft Prata', 55.5, 'Em Análise'),
(46, 1, 8, 0, 'Soft Prata', 55.5, 'Em Análise'),
(47, 1, 8, 0, 'Soft Prata', 55.5, 'Em Análise'),
(48, 1, 8, 0, 'Soft Prata', 55.5, 'Em Análise'),
(49, 1, 154, 16, 'Soft Prata', 214.5, 'Ativo');
...
--
ALTER TABLE `enderecofuncionario`
  MODIFY `idEnderecoFuncionario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `formapagamento`
--
ALTER TABLE `formapagamento`
  MODIFY `idFormaPagamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `seguro`
  MODIFY `idSeguro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
